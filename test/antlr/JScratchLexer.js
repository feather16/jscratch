...
exports.JScratchLexer = void 0;
const ATNDeserializer_1 = require("antlr4ts/atn/ATNDeserializer");
const Lexer_1 = require("antlr4ts/Lexer");
const LexerATNSimulator_1 = require("antlr4ts/atn/LexerATNSimulator");
const VocabularyImpl_1 = require("antlr4ts/VocabularyImpl");
const Utils = __importStar(require("antlr4ts/misc/Utils"));
class JScratchLexer extends Lexer_1.Lexer {
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    constructor(input) {
        super(input);
        this._interp = new LexerATNSimulator_1.LexerATNSimulator(JScratchLexer._ATN, this);
    }
    // @Override
    get grammarFileName() { return "JScratch.g4"; }
    // @Override
    get ruleNames() { return JScratchLexer.ruleNames; }
    // @Override
    get serializedATN() { return JScratchLexer._serializedATN; }
    // @Override
    get channelNames() { return JScratchLexer.channelNames; }
    // @Override
    get modeNames() { return JScratchLexer.modeNames; }
    static get _ATN() {
        if (!JScratchLexer.__ATN) {
            JScratchLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(JScratchLexer._serializedATN));
        }
        return JScratchLexer.__ATN;
    }
}
exports.JScratchLexer = JScratchLexer;
JScratchLexer.T__0 = 1;
JScratchLexer.T__1 = 2;
JScratchLexer.T__2 = 3;
JScratchLexer.T__3 = 4;
JScratchLexer.T__4 = 5;
JScratchLexer.T__5 = 6;
JScratchLexer.T__6 = 7;
JScratchLexer.T__7 = 8;
JScratchLexer.T__8 = 9;
JScratchLexer.T__9 = 10;
JScratchLexer.T__10 = 11;
JScratchLexer.T__11 = 12;
JScratchLexer.T__12 = 13;
JScratchLexer.T__13 = 14;
JScratchLexer.T__14 = 15;
JScratchLexer.T__15 = 16;
JScratchLexer.T__16 = 17;
JScratchLexer.ADD_OPERATOR = 18;
JScratchLexer.MUL_OPERATOR = 19;
JScratchLexer.LOGICAL_ADD_OPERATOR = 20;
JScratchLexer.LOGICAL_MUL_OPERATOR = 21;
JScratchLexer.LOGICAL_NOT_OPERATOR = 22;
JScratchLexer.COMPOUND_ASSIGN_OPERATOR = 23;
JScratchLexer.REL_OPERATOR = 24;
JScratchLexer.CONSTANT = 25;
JScratchLexer.IDENTIFIER = 26;
JScratchLexer.NUMBER_CONSTANT = 27;
JScratchLexer.STRING_CONSTANT = 28;
JScratchLexer.ARRAY_SIZE = 29;
JScratchLexer.WS = 30;
JScratchLexer.MultiLineComment = 31;
JScratchLexer.SingleLineComment = 32;
// tslint:disable:no-trailing-whitespace
JScratchLexer.channelNames = [
    "DEFAULT_TOKEN_CHANNEL", "HIDDEN",
];
// tslint:disable:no-trailing-whitespace
JScratchLexer.modeNames = [
    "DEFAULT_MODE",
];
JScratchLexer.ruleNames = [
...
JScratchLexer._LITERAL_NAMES = [
    undefined, "';'", "'{'", "'}'", "'var'", "','", "'const'", "'constexpr'",
    "'='", "'['", "']'", "'('", "')'", "'if'", "'else'", "'while'", "'function'",
    "'return'", undefined, undefined, "'|'", "'&'", "'!'",
];
JScratchLexer._SYMBOLIC_NAMES = [
...
JScratchLexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(JScratchLexer._LITERAL_NAMES, JScratchLexer._SYMBOLIC_NAMES, []);
JScratchLexer._serializedATN = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\"\u0102\b\x01" +
