...
exports.builtInFuncs = exports.builtInProcs = exports.BuiltInFunc = exports.BuiltInProc = void 0;
class BuiltInProc {
...
exports.BuiltInProc = BuiltInProc;
class BuiltInFunc {
    constructor(name, numArgs) {
        this.name = name;
        this.numArgs = numArgs;
...
exports.BuiltInFunc = BuiltInFunc;
exports.builtInProcs = [
